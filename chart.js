...
// Overall Performance
overallPerformanceValue.textContent =
    studentData.overallPerformance + "%";

overallPerformanceStatus.textContent =
    getPerformanceStatus(studentData.overallPerformance);


// Enrolled Subjects
enrolledSubjectValue.textContent =
    studentData.subjectsEnrolled;
...
attendanceStatus.textContent =
    getAttendanceStatus(studentData.attendance);


// Study Hours
studyHoursValue.textContent =
    studentData.studyHours + " hrs";

studyHoursStatus.textContent =
    "Today";


// AI Risk Level
aiRiskLevelValue.textContent =
    studentData.aiRiskLevel;

aiRiskLevelStatus.textContent =
    getRiskStatus(studentData.aiRiskLevel);
